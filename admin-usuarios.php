...
?>
      ...
      <input value="Editar usuario" type="submit" name="editarUsuario" id="editarUsuario" onclick="return ModificarUsuario('editar')">
          <input value="Crear usuario" type="submit" name="crearUsuario" id="subir-libro" onclick="return ModificarUsuario('crear')">
            ...
            <div class="datos-usuario">
              ...
              <select style="background-color: white; color: black; width: 20%;" name="selecRol" id="selecRol" class="form-control"
            ...
            <div>
              ...
              <input name="txtDNI" style="background-color: white; color: black; width: 20%;" type="text" placeholder="Ingresar dato">
              <label for="" style="width: 100px;">Mail:</label>
              <input name="txtMail" style="background-color: white; color: black; width: 20%;" type="text" placeholder="Ingresar dato">
              <label for="" style="width: 100px;">Alta mail:</label>
              <select style="background-color: white; color: black; width: 20%;" name="selecEstadoMail" id="selecEstadoMail" 
            ...
            <div>
              ...
              <select style="background-color: white; color: black; width: 20%;" name="selecEstadoUsuario" id="selecEstadoUsuario" 
                class="form-control" style="width: 200px; margin-right: 200px;">
                <option value="" disabled selected >Seleccionar estado</option>
