...
if (isset($_SESSION['pages']) && isset($_SESSION['busqueda']) && isset($_SESSION['criterio'])) {
      ...
      <input value="Editar usuario" type="submit" name="editarUsuario" id="editarUsuario" onclick="return ModificarUsuario('editar')">
          ...
          <input name="txtID" type="hidden" name="genero" id="genero" placeholder="Seleccionar">
          ...
          <form name="formUsuarios" action="" method="POST" class="form-libro">
            <div class="datos-usuario">
              ...
              <input name="txtApellido" style="background-color: white; color: black; width: 20%;" type="text"
                name="autor" id="autor" placeholder="Ingresar dato">
              <label for="" style="width: 100px;">Rol: </label>
              <select style="background-color: white; color: black; width: 20%;" name="selecRol" class="form-control"
            ...
            <div>
              ...
              <input name="txtDNI" style="background-color: white; color: black; width: 20%;" type="text" name="desc"
                id="desc" placeholder="Ingresar dato">
              <label for="" style="width: 100px;">Mail:</label>
              <input name="txtMail" style="background-color: white; color: black; width: 20%;" type="text" name="genero"
                id="genero" placeholder="Ingresar dato">
